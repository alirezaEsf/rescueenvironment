...
export const defaultNavigation: FuseNavigationItem[] = navigations.concat(defaultNav);
export const compactNavigation: FuseNavigationItem[] = navigations.concat(compNavigation);
export const futuristicNavigation: FuseNavigationItem[] = navigations.concat(futurNavigation)
export const horizontalNavigation: FuseNavigationItem[] = navigations.concat(horizNavigation)
